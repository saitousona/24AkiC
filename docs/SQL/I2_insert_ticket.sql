...
INSERT INTO ticket (ticket_id, email, title, deadline, assigned_person, importance, progress, category) VALUES (ticket_sequence.NEXTVAL, 'ss23304007@ga.ttc.ac.jp', '共有テスト', TO_DATE('2024-11-08', 'YYYY-MM-DD'), 'mt23304012@ga.ttc.ac.jp', '中', 0, '会議');
...
INSERT INTO ticket (ticket_id, email, title, deadline, assigned_person, importance, progress, category) VALUES (ticket_sequence.NEXTVAL, 'mt23304012@ga.ttc.ac.jp', '共有テスト', TO_DATE('2024-11-08', 'YYYY-MM-DD'), 'ss23304007@ga.ttc.ac.jp', '中', 0, '会議');
